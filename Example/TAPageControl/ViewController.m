...
- (void)viewDidLoad
{
    ...
    UIImage *commonImg = [UIImage sq_imageWithColor:[UIColor redColor] andSize:CGSizeMake(8, 8)];
    UIImage *currentImg = [UIImage sq_imageWithColor:[UIColor greenColor] andSize:CGSizeMake(8, 16)];
//    self.customPageControl3.currentDotWidthRatio = 1;
